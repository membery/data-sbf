...
.config(['$translateProvider', function($translateProvider) {
	...
	$translateProvider.translations('sk', {
		"menu.search.playerBaseball.lower.level":"Hľadať baseball hráča",
		"menu.search.playerSoftball.lower.level":"Hľadať softball hráča",
		"menu.search.officerBaseball.lower.level":"Hľadať baseball funkcionára",
		"menu.search.officerSoftball.lower.level":"Hľadať softball funkcionára",
		"menu.stadium.title": "Športový objekt",
		"menu.company.title": "Organizácia",
		"menu.roster.title": "Družstvo",
		...
		"menu.requests.new.stadium.lower.level":"Nový objekt",
		"menu.requests.search.stadium.lower.level":"Hľadať objekt",
		...
		"schema.people.scorer.firstAssociation":"Prvotný zväz",
		"schema.people.scorer.stateOfScorer":"Stav zapisovateľa",
		"schema.people.scorer.association":"Aktuálny zväz",
		"schema.people.scorer.firstYear":"Rok začiatku kariéry",
		"schema.people.scorer.proffesionalCompetence":"Odborná spôsobilosť od (rok)",
		"schema.people.scorer.dateOfRegistration":"Dátum registrácie",
		"schema.people.scorer.scorerLicense":"Licencia zapisovateľa",
		"schema.people.scorer.scorerLicenseType":"Typ licencie",
		"schema.people.scorer.dateOfExpiration":"Dátum platnosti preukazu",
		"schema.people.scorer.dateOfApplicationForId":"Dátum začiatku platnosti preukazu",
		"schema.people.scorer.feeDate":"Poplatky",
		"schema.people.scorer.licenseSeminar":"Licenčný seminár",
		...
		"schema.people.scorer.baseball":"Zapisovateľ baseball",
		...
		"schema.people.scorer.softball":"Zapisovateľ softball",
		...
		"schema.stadiumRequests.title":"Žiadosť o športový objekt",
		...
		"schema.refereeReport.baseData.state.created":"Vytvorený",
		"schema.refereeReport.baseData.state.approved":"Schválený",
		"schema.refereeReport.baseData.matchNumber":"Číslo webu",
	...
	$translateProvider.translations('cz', {
		...
		"menu.logins.lower.level": "História přihlásení",
		...
		"menu.search.playerBaseball.lower.level":"Hledat baseball hráča",
		"menu.search.playerSoftball.lower.level":"Hledat softball hráča",
		"menu.search.officerBaseball.lower.level":"Hľadať baseball funkcionára",
		"menu.search.officerSoftball.lower.level":"Hľadať softball funkcionára",
		...
		"schema.stadiumRequests.title":"Žádost o sportovní objekt",
		"schema.transferRequests.title": "Žiadosť o zmenu kl. príslušnosti hráča",
		"schema.transferRequests.officer.title": "Žiadosť o zmenu kl. príslušnosti funkcionára",
